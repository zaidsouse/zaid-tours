      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {[['name', 'Full Name', 'text', 'John Doe'], ['email', 'Email', 'email', 'your@email.com'], ['phone', 'Phone Number', 'tel', '+962 79 000 0000'], ['password', 'Password', 'password', '••••••••'], ['confirm', 'Confirm Password', 'password', '••••••••']].map(([k, label, type, ph]) => (
              <div key={k}>
